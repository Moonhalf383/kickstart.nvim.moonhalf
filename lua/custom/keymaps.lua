...
vim.keymap.set('n', '<leader>bl', '<cmd>bnext<CR>', { desc = 'Go to [N]ext [B]uffer' })
vim.keymap.set('n', '<leader>bh', '<cmd>bprevious<CR>', { desc = 'Go to [P]revious [B]uffer' })
vim.keymap.set('n', '<leader>bq', '<cmd>bdelete<CR>', { desc = '[D]elete/close buffer' })
